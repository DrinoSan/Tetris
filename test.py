...
class TestBlock(unittest.TestCase):
    def setUp(self):
        ...
        self.game.score_dictionary = {0: 0, 1: 40, 2: 100, 3: 300, 4: 1200}
    ...
    def testRemoveLineToAddToScore(self):
        ...
        self.assertTrue(
            self.game.score == 40, msg="Remove line does not calculate score correctly"
        )

    # Public Test 5
    def testCaculateNewLevel(self):
        res = []
        ...
        self.assertTrue(
            ...
            msg="calculateNewLevel does not work correctly",
        )
    ...
    def testSetGameSpeed(self):
        ...
        self.assertTrue(
            self.game.speed == 100, msg="setGameSpeed does not work correctly"
        )
    ...
    def testBlockNameAndColor(self):
        ...
        self.assertTrue(
            block.name == "teewee", msg="Name {} is not teewee".format(block.name)
        )
        self.assertTrue(
            block.color == "purple", msg="Color {} is not purple".format(block.color)
        )
    ...
    def testRotateRight(self):
        ...
        self.assertTrue(
            res == block.rotation,
            msg="Block was not correctly rotated: is {} should be {}".format(
                block.rotation, res
            ),
        )
    ...
    def testSetShape(self):
        ...
        self.assertTrue(
            ["xxxx"] == block.shape,
            msg="Block does not have correct width: is {} should be {}".format(
                block.shape, ["xxxx"]
            ),
        )
        self.assertTrue(
        ...
        self.assertTrue(
            1 == block.height,
            msg="Block does not have correct height: is {} should be {}".format(
                block.height, 1
            ),
        )
